                ...
                <div class="card-body" style="background: linear-gradient(#535fff,#7597de); padding-top: 10px;">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3 mt-3">
                            <label style="color: azure;"for="name" class="col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label style="color: azure;"for="email" class="col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label style="color: azure;"for="password" class="col-md-4 col-form-label text-md-end">{{ __('Password') }}</label>
                        ...
                        <div class="row mb-3">
                            <label style="color: azure;"for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Confirm Password') }}</label>
